...
for i=1, 6 do
	...
	t[#t+1] = LoadActor(THEME:GetPathG("", "_pt" .. i)) .. {
		InitCommand=cmd(zoomto,SCREEN_WIDTH,SCREEN_HEIGHT;Center;sleep,4),
		OnCommand=cmd(diffusealpha,0;sleep,4;sleep,sleep_time;linear,0.10;diffusealpha,1)
	}
	t[#t+1] = LoadActor(THEME:GetPathG("", "logo")) .. {
		InitCommand=cmd(zoom,0.3;Center;sleep,4),
		OnCommand=cmd(diffusealpha,0;sleep,4;sleep,sleep_time;linear,0.10;diffusealpha,1)
	}
